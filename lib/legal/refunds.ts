      ...
      body: [
        `For websites, video, ads, software, automation, brand work, consultations, and optional extras:`,
        {
          list: [
            ...
            "If you pay with Klarna or Afterpay, any refund we agree to goes back through that provider, and its own timing and rules apply. Your installments are between you and them.",
            "If you pay a deposit on a large build, the deposit is not refundable, and the remaining balance stays due before your final files are released or your site is launched. We may hold delivery until it is paid.",
