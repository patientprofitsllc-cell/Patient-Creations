...
export const termsDoc: LegalDoc = {
  ...
  sections: [
    ...
    {
      id: "care-plan",
      title: "9. Subscriptions: Website Care Plan and Monthly Ads plans",
      body: [
        ...
        `MONTHLY ADS PLANS: A Monthly Ads plan is an optional monthly subscription in which we make advertising creative for you. What a plan includes is the list shown for that plan when you start it, for example a set number of short video ads, cinematic showcase videos, 3D visuals, or landing pages each month, with the stated number of revision rounds. Each month's items and revisions are for that month only, do not carry over, and are not refunded or credited if unused. Send your monthly brief early, because we can only make what we have a brief for. Our delivery times are targets, not guarantees. We deliver finished files by download link and show them on your private plan page; we do not post for you.`,
        `A Monthly Ads plan does not include ad spend, which you pay directly to the ad platform; running, managing, or optimizing your ad accounts or campaigns; posting on your behalf; real actors, models, or recorded voices; music rights or licensed music; or any promise of sales, leads, followers, rankings, or any other result. Presenters, voices, and images in the work may be generated by artificial intelligence. Some ad platforms require ads that contain AI-generated people or voices to be labeled or disclosed, and following each platform's rules for your ads and account is your responsibility. You are responsible for the claims your ads make and for having the right to any product, brand, or material you give us.`,
        `Monthly Ads plans renew automatically on the same terms as the Website Care Plan above: you authorize us, through Stripe, to charge the price shown when you started, every month, until you cancel; you can cancel any time from your plan page or by emailing ${C.email}, effective at the end of the paid month; and we do not refund or prorate any billed period. If a payment fails we may retry it and may pause work until it is paid. To change plans, contact us and we will switch you at the next billing date. We may change a plan's price or contents with at least 30 days' notice.`,
      ],
    },
    {
      id: "merch",
    ...
    },
    {
      ...
      body: [
        ...
        `Deposits and final payments. On orders over ${usd(DEPOSIT.overCents)} that ship no physical goods, we may let you start with a deposit of ${DEPOSIT.percent}% of the order total instead of paying in full. The deposit starts production. The rest is invoiced when your build is ready, and it is due before we release the final files, deliver, or launch your website. We may hold delivery and launch until it is paid. A deposit is a payment toward your order, not a refundable reservation, and it is covered by the Refund and Cancellation Policy. If we bill you separately for extra work you asked for, that invoice is due when you receive it, and paying it adds to your order.`,
        `Paying over time. At checkout you may be able to pay by card, or to split a payment with Klarna or Afterpay. If you choose Klarna or Afterpay, that company decides whether you qualify, collects your installments, and applies its own terms and policies. We are paid the full amount at the time you pay, and we are not a party to your agreement with them. Your order is still subject to these Terms and our Refund and Cancellation Policy, and any refund we agree to is returned through the same provider.`,
