...
const SERVICES: ServiceDef[] = [
  ...
  },
  {
    ...
    baseCents: PRICE_CENTS["rental-listing-film"],
    tierable: true,
    revisionLimit: 1,
    turnaround: "5-7 days",
    sortOrder: 5,
  },
  {
    ...
    baseCents: PRICE_CENTS["payments-setup"],
    tierable: true,
    revisionLimit: 1,
    turnaround: "3-6 days",
    sortOrder: 6,
  },
  {
    ...
    baseCents: PRICE_CENTS["lead-engine"],
    tierable: true,
    revisionLimit: 2,
    turnaround: "2-3 weeks",
    sortOrder: 7,
  },
  {
    ...
    baseCents: PRICE_CENTS["strategy-session"],
    tierable: false,
    revisionLimit: 0,
  ...
  },
  {
    ...
    baseCents: PRICE_CENTS["custom-build"],
    tierable: false,
    revisionLimit: 0,
  ...
  },
  {
    ...
    baseCents: PRICE_CENTS["basic-package"],
    tierable: false,
    revisionLimit: 2,
    turnaround: "1-2 weeks",
    sortOrder: 10,
  ...
  // grid; they're bought through the special cards on the homepage.
  {
    ...
    baseCents: PRICE_CENTS["cinematic-ad-special"],
    tierable: false,
    revisionLimit: 1,
    turnaround: "5-7 days",
    sortOrder: 20,
  },
  {
    ...
    baseCents: PRICE_CENTS["ugc-ad-special"],
    tierable: false,
    revisionLimit: 1,
    turnaround: "5-7 days",
    sortOrder: 21,
  },
  {
    ...
    baseCents: PRICE_CENTS["all-in-one-bundle"],
    tierable: false,
    revisionLimit: 2,
    turnaround: "2-3 weeks",
    sortOrder: 22,
...
const ADD_ONS: {
...
}[] = [
  {
    ...
    priceCents: PRICE_CENTS["brand-kit"],
    revisionLimit: 1,
    sortOrder: 1,
  },
  {
    ...
    priceCents: PRICE_CENTS["extra-revision-package"],
    revisionLimit: 0,
    sortOrder: 2,
  },
  {
    ...
    priceCents: PRICE_CENTS["social-asset-pack"],
    revisionLimit: 0,
    sortOrder: 3,
  },
  {
  ...
  },
  {
    ...
    priceCents: PRICE_CENTS["automation-add-on"],
    revisionLimit: 1,
    sortOrder: 1,
  },
  {
    ...
    priceCents: PRICE_CENTS["care-plan"],
  ...
  for (const s of SERVICES) {
    ...
    if (s.tierable) {
      const tiers: { name: string; priceCents: number }[] = [
        { name: "Signature", priceCents: tierPriceCents(s.slug, "Signature", s.baseCents) },
        { name: "Flagship", priceCents: tierPriceCents(s.slug, "Flagship", s.baseCents) },
      ];
