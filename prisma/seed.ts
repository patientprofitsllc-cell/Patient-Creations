...
const SERVICES: ServiceDef[] = [
  {
    ...
    category: "Websites",
    description: "A beautiful, professional website — built fast and easy for anyone to use.",
    baseCents: 200000,
    tierable: true,
    revisionLimit: 2,
  ...
  },
  {
    ...
    category: "Software",
    description: "A real app with logins, payments, and AI built right in.",
    baseCents: 400000,
    tierable: true,
    revisionLimit: 3,
  ...
  },
  {
    ...
    category: "Automation",
    description: "A team of AI workers that get things done for you, automatically.",
    baseCents: 600000,
    tierable: true,
    revisionLimit: 3,
  ...
  },
  {
    ...
    category: "Video",
    description: "A stunning video tour that gets your rental booked faster.",
    baseCents: 50000,
    tierable: true,
    revisionLimit: 1,
    turnaround: "5-7 days",
  ...
  },
  {
    ...
    name: "Payments Setup",
    category: "Commerce",
    description: "Start taking real card payments on your website or app, one-time or monthly.",
    baseCents: 90000,
    tierable: true,
    revisionLimit: 1,
    turnaround: "3-6 days",
  ...
  },
  {
    ...
    description: "A drone-style video tour of your building and storefront, so customers know exactly where to go before they visit.",
    baseCents: 100000,
    tierable: false,
    revisionLimit: 1,
    turnaround: "3-5 days",
...
const ADD_ONS: {
  ...
  },
  {
    ...
    category: "Add-on",
    type: "ORDER_BUMP",
    description: "Add NFC growth cards in the designs of your choice (Google Review, YouTube, Menu, WiFi, and more), $55 each. Special: add 10 or more and every card is $50. Tell us which designs right after checkout.",
    priceCents: 5500,
    revisionLimit: 0,
    sortOrder: 5,
  },
